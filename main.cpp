...
private:
    ...
    void pickPhysicalDevice()
    {
        ...
        if (deviceCount == 0)
        {
            throw std::runtime_error("Unable to find a device with Vulkan support.");
        }
        ...
        {
            throw std::runtime_error("Unable to find a suitable Vulkan device.");
        }
    }
    ...
    void createSwapChain()
    {
        ...
        // maxImageCount of zero indicates unlimited max
    ...
    bool checkDeviceExtensionSupport(VkPhysicalDevice device)
    {
        ...
        {
            // std::cout << "Found extension " << extension.extensionName << std::endl;
    ...
    SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device)
    {
        ...
        if (formatCount != 0)
        {
            ...
            // {
            //     std::cout << "Found format " << format.format << std::endl;
            // }
        }
        ...
        if (presentModeCount != 0)
        {
            ...
            // for (auto const &present : details.presentModes)
            // {
            //     std::cout << "Present mode " << present << std::endl;
            // }
        }
    ...
    void createInstance()
    {
        ...
        {
            std::cout << "No validation layers." << std::endl;
            createInfo.enabledLayerCount = 0;
        ...
        void *pUserData)
    {
        ...
        case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT:
            ...
            break;
        default:
            std::cerr << " > Validation layer DEFAULT: " << pCallbackData->pMessage << std::endl;
            break;
        }
